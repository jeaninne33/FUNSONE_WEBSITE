...
class GalleriesControllerTest < ActionController::TestCase
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post :create, gallery: { descripcion: @gallery.descripcion, fecha: @gallery.fecha, lugar: @gallery.lugar, nombre: @gallery.nombre }
    end
  ...
  test "should update gallery" do
    patch :update, id: @gallery, gallery: { descripcion: @gallery.descripcion, fecha: @gallery.fecha, lugar: @gallery.lugar, nombre: @gallery.nombre }
    assert_redirected_to gallery_path(assigns(:gallery))
  end
