...
class PaintingsControllerTest < ActionController::TestCase
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post :create, painting: { foto: @painting.foto, gallery_id: @painting.gallery_id, nombre: @painting.nombre }
    end
  ...
  test "should update painting" do
    patch :update, id: @painting, painting: { foto: @painting.foto, gallery_id: @painting.gallery_id, nombre: @painting.nombre }
    assert_redirected_to painting_path(assigns(:painting))
  end
