...
class TiposControllerTest < ActionController::TestCase
  ...
  test "should create tipo" do
    assert_difference('Tipo.count') do
      post :create, tipo: { contactos: @tipo.contactos, objetivo: @tipo.objetivo, requisito: @tipo.requisito, tipo: @tipo.tipo }
    end
  ...
  test "should update tipo" do
    patch :update, id: @tipo, tipo: { contactos: @tipo.contactos, objetivo: @tipo.objetivo, requisito: @tipo.requisito, tipo: @tipo.tipo }
    assert_redirected_to tipo_path(assigns(:tipo))
  end
